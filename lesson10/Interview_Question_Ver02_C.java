...
public class Interview_Question_Ver02_C {
    public static void main(String[] args) throws InterruptedException {
        ...
        superCalculator.calcFunc(driver, wait, superCalculator.randFunc(driver));
        driver.quit();
    }
}

class superCalculator {
    public static String randFunc(WebDriver driver) throws InterruptedException {
    ...
    public static void calcFunc(WebDriver driver , WebDriverWait wait, String strRandomNumber) {
